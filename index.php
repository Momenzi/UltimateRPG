...
<head>
    <meta charset="UTF-8" />
    <title>Ultimate Community</title>
...
<section class="overflowing">
        ...
        <div class="fluid-width">
            ...
            <div class="middle">
                ...
                <div class="button-line">
                    <a href="samp://samp.ultimate-rpg.com:7777"><button class="primary-button">
                ...
                <div class="social-wrapper">
                    <ul>
                        <li><a href="https://discord.ultimate-rpg.com" target="_blank"><img src="images/discord.png" alt=""></a></li>
                        <li><a href="https://facebook.com/ultimatecommunity" target="_blank"><img src="images/svg/facebook.png" alt=""></a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="owl-carousel owl-news">
                    ...
                    <div>
                        <div class="news-item">
                            ...
                            <div class="news-info">
                                <p class="news-title">Update v1.2</p>
                    ...
                    <div>
                        <div class="news-item">
                            ...
                            <div class="news-info">
                                <p class="news-title">Update v1.3</p>
                                <p class="news-text">Vise informacija pogledajte na nasem forumu.</p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="main-width">
            ...
            <div class="follow-grid">
                <div>
                    ...
                    <a href="http://discord.ultimate-rpg.com" target="_blank"><button class="primary-button mini">
                        <p>Connect</p>
                    </button></a>
                </div>
                <div>
                    <p><strong><img src="images/svg/facebook.png" alt=""> Facebook stranica</strong></p>
                    <a href="https://facebook.com/ultimatecommunity" target="_blank"><button class="primary-button mini">
                        <p>Pregledaj</p>
                    </button></a>
                </div>
            </div>
    ...
    <div class="footer">
        <div class="fluid-width column-middle">
            ...
            <a href="http://facebook.com/momenzi.amx" class="href-easy">CODED BY MOMENZI</a>
        </div>
    </div>
</section>
<!-- UCP COMING SOON -->
